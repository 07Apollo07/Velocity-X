...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: PdfViewerWebPDFTron(title: 'PDFTron WebViewer for Flutter'),
    );
  }
}

class PdfViewerWebPDFTron extends StatefulWidget {
  PdfViewerWebPDFTron({ required this.title});
  ...
  @override
  _PdfViewerWebPDFTronState createState() => _PdfViewerWebPDFTronState();
}

class _PdfViewerWebPDFTronState extends State<PdfViewerWebPDFTron> {
